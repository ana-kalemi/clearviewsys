function refreshTable() {
    ...
    table_header += "<td class=\"headerbuy\">Buy FC</td>";
    table_header += "<td class=\"headersell\">Sell FC</td>";
    table_header += "</tr>";
    ...
    new Ajax.Request('rateswithcss.xml',
        {
            ...
            onSuccess: function (transport) {
                ...
                var time = '<div class="rate-time">';
                time += xmlDoc.getElementsByTagName("TIMESTAMP")[0].childNodes[0].nodeValue;
                time += '</div>';
                ...
                for (var i = 0; i < rate_array.length; i++) {
                    ...
                    if (i % 2 == 0) {
                        table_rows += "<tr class=\"row_even\"><td class='flag'><img src=\"../" + r_flagurl + "\""
                    }
                    else {
                        table_rows += "<tr class=\"row_odd\"><td class='flag'><img src=\"../" + r_flagurl + "\""
                    }

function refreshTable() {
	...
	var table_header = "<table style=\" border-collapse: collapse; \" >"
	
	table_header +="<tr id=\"currency_widget_table_header\" ><td class=\"header\"></td>"
	...
	table_header += "<td class=\"headerbuy\">Buy Rate</td>"
	table_header += "<td class=\"headersell\">Sell Rate</td>"
	table_header += "</tr>";
	...
	new Ajax.Request('rateswithcss.xml',
		{
    		...
    		onSuccess: function(transport) {
				...
				for (var i=0; i < rate_array.length; i++) 
				{
					...
					if (i%2 == 0) {
						table_rows += "<tr class=\"row_even\"><td><img src=\"../"+r_flagurl+"\""
					}
					else
					{
						table_rows += "<tr class=\"row_odd\"><td><img src=\"../"+r_flagurl+"\""
					}
					...
					table_rows += "</td><td class=\"inversebuy\">" + r_invbuy 

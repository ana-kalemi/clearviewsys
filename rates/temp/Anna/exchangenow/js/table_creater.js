...
jQuery(document).ready(function($){
    ...
    /*change icons color when hover(change image .png -> _active.png)*/
    $(function() {
        $(".header_title")
            .mouseover(function() {
                var str = $(this).find('.change_img').attr("src");
                var src = str.substring(0, str.length-4) + "_active.png";
                $(this).find('.change_img').attr("src", src);
            })
            .mouseout(function() {
                var src = $(this).find('.change_img').attr("src").replace("_active.png", ".png");
                $(this).find('.change_img').attr("src", src);
            });
    });

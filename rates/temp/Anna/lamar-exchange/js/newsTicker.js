        ...
        Plugin.prototype = {
                ...
                moveDown: function() {
                        if (!this.moving) {
                                ...
                                this.$el.children('tr:last, li:last').detach().prependTo(this.$el).css('marginTop', '-' + this.options.row_height + 'px')
                ...
                moveUp: function() {
                        if (!this.moving) {
                                ...
                                var element = this.$el.children('tr:first, li:first');

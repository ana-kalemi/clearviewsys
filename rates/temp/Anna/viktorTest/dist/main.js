...
/* harmony import */ var _myName__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(2);
...
function component() {
    ...
    // Lodash, no imported by this script
    // element.innerHTML = _.join(['Hello', 'webpack'], ' ');
    element.innerHTML =(0,_myName__WEBPACK_IMPORTED_MODULE_1__.default)('Viktor')
...
// setInterval(doSMTHIG, 1000)

function getXML() {
    fetch("./rateswithcss.xml")
        .then(response => response.text())
        .then(data => {
            const parser = new DOMParser();
            const xml = parser.parseFromString(data, "application/xml");
            console.log(xml);
            let c = xml.querySelector('RATE')
            console.log(c.querySelector("WEBUY").textContent);

function refreshTable() {
	...
	table_header +="<tr id=\"currency_widget_table_header\"><td class=\"header\">Flag</td>";
	//table_header += "<td class=\"header\"></td>";
	table_header += "<td class=\"header\">Code</td>";
	table_header += "<td class=\"header\">Currency</td>";
	table_header += "<td class=\"header\">We Buy</td>";
	table_header += "<td class=\"header\">We Sell</td>";
	...
	new Ajax.Request('rateswithcss.xml',
		{
    		...
    		onSuccess: function(transport) {
				...
				for (var i=0; i < rate_array.length; i++) 
				{
					...
					table_rows += "<tr><td class='flag'><img src=\"../"+r_flagurl+"\"";

function refreshTable() {
    ...
    table_header += "<tr id=\"currency_widget_table_header\">";
    table_header += "<td></td>";
    ...
    new Ajax.Request('rateswithcss.xml',
        {
            ...
            onSuccess: function (transport) {
                ...
                for (var i = 0; i < rate_array.length - 1; i++) {
                    ...
                    var r_code3 = rate_array[i + 2].getElementsByTagName("ISO")[0].childNodes[0].nodeValue;
                    var r_webuy3 = rate_array[i + 2].getElementsByTagName("WEBUY")[0].childNodes[0].nodeValue;
                    var r_wesell3 = rate_array[i + 2].getElementsByTagName("WESELL")[0].childNodes[0].nodeValue;
                    var r_flagurl3 = rate_array[i + 2].getElementsByTagName("FLAGURL")[0].childNodes[0].nodeValue;
                    ...
                    table_rows += "</td><td class=\"flag\"><img src=\"../" + r_flagurl3 + "\"";
                    table_rows += "/>";
                    table_rows += "</td><td class=\"code\">" + r_code3;
                    table_rows += "</td><td class=\"buy\">" + r_webuy3;
                    table_rows += "</td><td class=\"sell\">" + r_wesell3;

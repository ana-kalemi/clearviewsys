function refreshTable() {
	var table_header = "<table><tr id=\"currency_widget_table_header\" ><td></td><td class=\"header\">Country</td><td class=\"header\">Currency</td><td class=\"headerbuy\">BUY</td><td class=\"headersell\">SELL</td><td class=\"headerbuy\">Inv. Buy</td><td class=\"headersell\">Inv. Sell</td></tr>";
	var table_rows = "";
	...
	new Ajax.Request('rateswithcss.xml',
		{
    		...
    		onSuccess: function(transport) {
				...
				for (var i=0; i < rate_array.length; i++) {
					...
					if (i%2 == 0) {
						table_rows += "<tr class=\"row_even\"><td><img src=\""+r_flagurl+"\" /></td><td class=\"country\">" + r_country + "</td><td class=\"currency\">" + r_name + "</td><td class=\"buy\">" + r_webuy + "</td><td class=\"sell\">" + r_wesell + "</td><td class=\"inversebuy\">" + r_invbuy + "</td><td class=\"sell\">" + r_invsell + "</td></tr>";
					} else {
						table_rows += "<tr class=\"row_odd\"><td><img src=\""+r_flagurl+"\" /></td><td class=\"country\">" + r_country + "</td><td class=\"currency\">" + r_name + "</td><td class=\"buy\">" + r_webuy + "</td><td class=\"sell\">" + r_wesell + "</td><td class=\"inversebuy\">" + r_invbuy + "</td><td class=\"sell\">" + r_invsell + "</td></tr>";
					}
				}

...
# Ex: <a href="https://athena/cgi-bin/awredir/awredir.pl?url=https://212.43.217.240/%7Eforumgp/forum/list.php3?f=11">XXX</a>
#-------------------------------------------------------
...
if (! $ENV{'GATEWAY_INTERFACE'}) {	# Run from command line
	...
	print "<a href=\"https://externalsite/pagelinked\">Link</a>\n";
	print "to\n";
	print "<a href=\"https://mysite/cgi-bin/awredir.pl?url=https://externalsite/pagelinked\">Link</a>\n";
	print "\n";
...
if (! $Url) {
	error("Error: Bad use of $PROG. To redirect an URL with $PROG, use the following syntax:<br><i>/cgi-bin/$PROG.pl?url=https://urltogo</i>");
}
